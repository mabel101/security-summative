...
<head>
    ...
    <link rel="icon" href="mable.png"> 
    <title>Mable Student Management System</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: orange">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="mable.png" alt="..." width="5%">Mable Student Management System</b></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav" style="background-color: blue">
                <li class="dropdown">
